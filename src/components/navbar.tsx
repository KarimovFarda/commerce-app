...
<span>Favourites</span> <span style={{ color: "white", borderRadius: "50%", fontSize: "0.9rem", padding: "1px 7px", backgroundColor: "#f55a5a" }}>{favourites && favourites.length}</span></a>
            </li>
