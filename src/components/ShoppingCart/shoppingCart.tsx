        ...
        <table className="table table-hover">
          ...
          <tbody>
                ...
                return (
                  <tr onLoad={() => setTotalPrice(totalPrice + item.price * item.amount)}>
                    <td className="col-sm-8 col-md-6">
                      <div className="media">
                        <a className="thumbnail pull-left" href="#"> <img className="media-object" src={item.imageLink} /> </a>
            ...
            <tr>
              ...
              <td>   </td>
              <td>
                <button type="button" onClick={() => history.push('/products')} className="btn btn-default continue-shopping">
                  <span className="fa fa-shopping-cart "></span> Return Shopping
                </button></td>
              <td>
                <button type="button" onClick={() => { sessionStorage.setItem("totalPrice", String(totalPrice)); history.push("/payment") }} className="btn btn-success">
